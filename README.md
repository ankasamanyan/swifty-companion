...
Swifty-Companion is an iOS application designed to help 42 Network of software engineering schools' students keep track of their profiles, skills, and projects. It utilizes OAuth2 for authentication and interacts with the 42 API to fetch, search and display user data.
